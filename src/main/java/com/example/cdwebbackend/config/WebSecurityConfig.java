...
//                        .requestMatchers(POST, apiPrefix + "/users/forgotPass").permitAll()
...
//                        .requestMatchers(apiPrefix + "/ghn/districts").permitAll()
//                        .requestMatchers(apiPrefix + "/carts?**").hasRole(RoleEntity.USER)
//                        .requestMatchers(apiPrefix + "/carts/add").hasRole(RoleEntity.USER)
