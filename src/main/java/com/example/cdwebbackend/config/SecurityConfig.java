    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, apiPrefix + "/orders/total-revenue-by-month").hasRole(RoleEntity.ADMIN)
                        .requestMatchers(HttpMethod.GET, apiPrefix + "/orders/total-revenue-by-year").hasRole(RoleEntity.ADMIN)
